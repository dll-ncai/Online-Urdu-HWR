...
class JointModel(nn.Module):
    ...
    def __init__(self, trans_enc_d_model, trans_enc_nhead, trans_enc_layers, trans_enc_ff_dim,
                 tokenizer, trans_dec_d_model, trans_dec_nhead, trans_dec_layers, trans_dec_n_positions, freeze_decoder=True, decoder_path=None):
        super().__init__()
        ...
        self.transformer_decoder = get_decoder(vocab_size=tokenizer.vocab_size, d_model=trans_dec_d_model, 
                                               ...
                                               decoder_path=decoder_path, freeze=freeze_decoder)
