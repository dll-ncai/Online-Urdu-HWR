...
# -------------------------------
def run_experiment(seed, device, train_loader, eval_loader, tokenizer, root, g):
    set_seed(seed)
    ...
    run_dir = os.path.join(root, "runs_finetune_camera_ready", f"seed_{seed}")
    ...
    for epoch in range(max_epochs):
        ...
        filename = f"loss_curve_finetune_camera_ready_seed_{seed}.png"
...
def main():
    ...
    for seed in SEEDS:
        ...
        best_loss, best_cer = run_experiment(
            seed, device, train_loader, eval_loader, tokenizer, ROOT, g
        )
